...
var $author$project$Tablero$initTablero = F2(
	function (rows, cols) {
		return A3($perty$matrix$Matrix$repeat, rows, cols, $author$project$Tablero$Empty);
	});
...
var $author$project$Tetramino$rotationsI = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2(
			'R1',
...
var $author$project$Tetramino$rotationsJ = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2(
			'R1',
...
var $author$project$Tetramino$rotationsL = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2(
			'R1',
...
var $author$project$Tetramino$rotationsO = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2(
			'R1',
...
var $author$project$Tetramino$rotationsS = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2(
			'R1',
...
var $author$project$Tetramino$rotationsT = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2(
			'R1',
...
var $author$project$Tetramino$rotationsZ = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2(
			'R1',
...
var $author$project$Tetramino$rotations = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2('I', $author$project$Tetramino$rotationsI),
			_Utils_Tuple2('J', $author$project$Tetramino$rotationsJ),
			_Utils_Tuple2('L', $author$project$Tetramino$rotationsL),
			_Utils_Tuple2('O', $author$project$Tetramino$rotationsO),
			_Utils_Tuple2('T', $author$project$Tetramino$rotationsT),
			_Utils_Tuple2('S', $author$project$Tetramino$rotationsS),
			_Utils_Tuple2('Z', $author$project$Tetramino$rotationsZ)
		]));
var $author$project$Main$init = _Utils_Tuple2(
	{
		active: $elm$core$Maybe$Nothing,
		actualMsg: $author$project$Main$None,
		hold: $elm$core$Maybe$Nothing,
		holdAvailable: false,
		next: $elm$core$Maybe$Nothing,
		pausedState: $author$project$Main$NotStarted,
		points: 0,
		previousMsg: $author$project$Main$None,
		rotations: $author$project$Tetramino$rotations,
		state: $author$project$Main$NotStarted,
		stepTime: 1000.0,
		tablero: A2($author$project$Tablero$initTablero, 20, 10)
	},
...
var $author$project$Tablero$addOriginOffset = function (piece) {
	return A2(
		$elm$core$List$map,
		function (b) {
			return {x: b.x + piece.origin.x, y: b.y + piece.origin.y};
		},
		piece.blocks);
};
...
var $author$project$Tablero$testOutsideBounds = F2(
	function (piece, tablero) {
		var blocks = $author$project$Tablero$addOriginOffset(piece);
		var _v0 = $perty$matrix$Matrix$size(tablero);
		var x = _v0.a;
		var y = _v0.b;
		var testBlock = function (block) {
			return !((block.y < 0) || ((_Utils_cmp(block.x, x) > -1) || (_Utils_cmp(block.y, y) > -1)));
		};
		var reduceFun = F2(
			function (block, prev) {
				return prev && testBlock(block);
			});
		return A3($elm$core$List$foldl, reduceFun, true, blocks);
	});
...
var $author$project$Tablero$noOverlap = F2(
	function (tablero, _v0) {
		var x = _v0.x;
		var y = _v0.y;
		var _v1 = A3($perty$matrix$Matrix$get, tablero, x, y);
		if (_v1.$ === 'Nothing') {
			return true;
		} else {
			var tile = _v1.a;
...
var $author$project$Tablero$testOverlapp = F2(
	function (piece, tablero) {
		return A3(
			$elm$core$List$foldl,
			F2(
				function (block, prev) {
					return prev && A2($author$project$Tablero$noOverlap, tablero, block);
				}),
			true,
			$author$project$Tablero$addOriginOffset(piece));
	});
var $author$project$Tablero$testMovement = F2(
	function (piece, tablero) {
		return A2($author$project$Tablero$testOutsideBounds, piece, tablero) ? A2($author$project$Tablero$testOverlapp, piece, tablero) : false;
	});
var $author$project$Tablero$advancePiece = F2(
	function (p, tablero) {
		return A2(
			$elm$core$Maybe$map,
			function (piece) {
				var newPiece = _Utils_update(
					piece,
					{
						origin: {x: piece.origin.x + 1, y: piece.origin.y}
					});
				return A2($author$project$Tablero$testMovement, newPiece, tablero) ? newPiece : piece;
			},
			p);
	});
...
var $author$project$Tablero$Filled = function (a) {
	return {$: 'Filled', a: a};
};
...
var $perty$matrix$Matrix$indexedMap = F2(
...
var $author$project$Tablero$pointsTable = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2('1', 40),
			_Utils_Tuple2('2', 100),
...
var $author$project$Tablero$mapPoints = function (i) {
	var _v0 = A2($elm$core$Dict$get, i, $author$project$Tablero$pointsTable);
	if (_v0.$ === 'Just') {
		var p = _v0.a;
		return p;
	} else {
...
var $author$project$Main$removeDuplicates = function (list) {
	var set = $elm$core$Set$empty;
	var addIfNew = F2(
		function (item, s) {
			return A2($elm$core$Set$member, item, s) ? s : A2($elm$core$Set$insert, item, s);
		});
	return $elm$core$Set$toList(
		A3($elm$core$List$foldr, addIfNew, $elm$core$Set$empty, list));
};
...
var $author$project$Main$clearRows = F2(
	function (piece, model) {
		var max = function (list) {
			return A3(
				$elm$core$Array$foldl,
				F2(
					function (l, actualMax) {
						return (_Utils_cmp(l, actualMax) > 0) ? l : actualMax;
					}),
				0,
				list);
		};
		var isFull = F2(
			function (row, tfull) {
				return A3(
					...
					true,
					A2($perty$matrix$Matrix$getXs, tfull, row));
			});
		var getTopNeighbour = F4(
			function (tneigh, x, y, gap) {
				var _v2 = A3($perty$matrix$Matrix$get, tneigh, x - gap, y);
				if (_v2.$ === 'Just') {
					if (_v2.a.$ === 'Filled') {
						var p = _v2.a.a;
						return $author$project$Tablero$Filled(p);
					} else {
						return $author$project$Tablero$Empty;
					}
				} else {
					return $author$project$Tablero$Empty;
				}
			});
		var pushFilled = function (_v1) {
			var tpush = _v1.a;
			var rows = _v1.b;
			var maxRow = _v1.c;
			return A2(
				...
				rows,
				(rows > 0) ? A2(
					$perty$matrix$Matrix$indexedMap,
					F3(
						function (x, y, c) {
							return (_Utils_cmp(x, maxRow) > 0) ? c : A4(getTopNeighbour, tpush, x, y, rows);
						}),
					tpush) : tpush);
		};
		var clear = F2(
			function (tclear, rows) {
				return ($elm$core$Array$length(rows) > 0) ? _Utils_Tuple3(
					A3(
						$elm$core$Array$foldl,
						F2(
							function (r, t) {
								return A3(
									...
									F2(
										function (y, tt) {
											return A4($perty$matrix$Matrix$set, tt, r, y, $author$project$Tablero$Empty);
										}),
									t,
									A2(
										$elm$core$Array$initialize,
										$perty$matrix$Matrix$size(t).b,
										$elm$core$Basics$identity));
							}),
						tclear,
						rows),
					$elm$core$Array$length(rows),
					max(rows)) : _Utils_Tuple3(
					tclear,
					$elm$core$Array$length(rows),
					max(rows));
			});
			...
			A2(
				...
				$elm$core$Array$fromList(
					A2(
						...
						function (r) {
							return A2(isFull, r, model.tablero);
						},
						$author$project$Main$removeDuplicates(
							A2(
								...
								$author$project$Tablero$addOriginOffset(piece)))))));
		var amount = _v0.a;
		var newTablero = _v0.b;
		return _Utils_update(
			model,
			{
				points: model.points + $author$project$Tablero$mapPoints(
					$elm$core$Debug$toString(amount)),
				tablero: newTablero
			});
	});
var $author$project$Tablero$insertPiece = F2(
	function (piece, tablero) {
		return A3(
			$elm$core$List$foldl,
			F2(
				function (block, newTablero) {
					return A4(
						$perty$matrix$Matrix$set,
						newTablero,
						block.x + piece.origin.x,
						block.y + piece.origin.y,
						$author$project$Tablero$Filled(piece.tetramino));
				}),
			tablero,
			piece.blocks);
	});
...
var $author$project$Tetramino$I = {$: 'I'};
var $author$project$Tetramino$J = {$: 'J'};
var $author$project$Tetramino$L = {$: 'L'};
var $author$project$Tetramino$O = {$: 'O'};
var $author$project$Tetramino$S = {$: 'S'};
var $author$project$Tetramino$T = {$: 'T'};
var $author$project$Tetramino$Z = {$: 'Z'};
...
var $author$project$Tetramino$tetraminoGenerator = A2(
	$elm$random$Random$uniform,
	$author$project$Tetramino$I,
	_List_fromArray(
		[$author$project$Tetramino$O, $author$project$Tetramino$T, $author$project$Tetramino$S, $author$project$Tetramino$J, $author$project$Tetramino$Z, $author$project$Tetramino$L]));
var $author$project$Main$newPiece = A2($elm$random$Random$generate, $author$project$Main$NewPiece, $author$project$Tetramino$tetraminoGenerator);
...
var $author$project$Tablero$testGrounded = F2(
	function (piece, tablero) {
		var piecesInContact = A2(
			$elm$core$List$any,
			function (b) {
				var _v0 = A3($perty$matrix$Matrix$get, tablero, (b.x + piece.origin.x) + 1, b.y + piece.origin.y);
				if (_v0.$ === 'Just') {
					if (_v0.a.$ === 'Filled') {
						return true;
					} else {
			...
			piece.blocks);
		return piecesInContact ? _Utils_update(
			piece,
			{grounded: piece.grounded + 1}) : _Utils_update(
			piece,
			{grounded: 0});
	});
var $author$project$Main$groundPiece = function (model) {
	groundPiece:
	while (true) {
		...
		if (_v0.$ === 'Just') {
			var piece = _v0.a;
			if (piece.grounded < 3) {
				if ((piece.grounded > 0) && (_Utils_eq(model.previousMsg, model.actualMsg) && _Utils_eq(model.actualMsg, $author$project$Main$Advance))) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								active: $elm$core$Maybe$Just(
									A2($author$project$Tablero$testGrounded, piece, model.tablero))
							}),
						$elm$core$Platform$Cmd$none);
				}
			} else {
				var testedPiece = A2($author$project$Tablero$testGrounded, piece, model.tablero);
				var isEndGame = piece.origin.x <= 0;
				return (!testedPiece.grounded) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							active: $elm$core$Maybe$Just(
					...
					$elm$core$Platform$Cmd$none) : (isEndGame ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							active: $elm$core$Maybe$Nothing,
							holdAvailable: false,
							state: $author$project$Main$Finished,
							tablero: A2($author$project$Tablero$insertPiece, piece, model.tablero)
						}),
					$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					A2(
						$author$project$Main$clearRows,
						piece,
						_Utils_update(
							model,
							{
...
var $author$project$Tetramino$R4 = {$: 'R4'};
var $author$project$Tetramino$toString_r = function (r) {
	switch (r.$) {
		case 'R1':
			return 'R1';
		case 'R2':
...
var $author$project$Tetramino$toString_t = function (t) {
	switch (t.$) {
		case 'I':
			return 'I';
		case 'O':
...
var $author$project$Tetramino$getBlocks = F3(
	function (t, r, rts) {
		var rt = $author$project$Tetramino$toString_t(t);
		var rs = $author$project$Tetramino$toString_r(r);
		var _v0 = A2($elm$core$Dict$get, rt, rts);
		if (_v0.$ === 'Just') {
			var tetraRotations = _v0.a;
			var _v1 = A2($elm$core$Dict$get, rs, tetraRotations);
			if (_v1.$ === 'Just') {
				var tRotations = _v1.a;
				return tRotations;
			} else {
				return _List_Nil;
			}
...
var $author$project$Tablero$initPiece = F2(
	function (t, rts) {
		return {
			blocks: A3($author$project$Tetramino$getBlocks, t, $author$project$Tetramino$R4, rts),
			grounded: 0,
			origin: {x: -1, y: 3},
			r: $author$project$Tetramino$R4,
			tetramino: t
		};
	});
var $author$project$Tablero$rotate = F3(
	function (rts, r, p) {
		return _Utils_update(
			p,
			{
				blocks: A3($author$project$Tetramino$getBlocks, p.tetramino, r, rts),
				r: r
			});
	});
var $author$project$Main$holdPiece = function (model) {
	if (model.holdAvailable) {
		var _v0 = model.active;
		if (_v0.$ === 'Nothing') {
			return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		} else {
			var piece = _v0.a;
			var toBeHolded = $elm$core$Maybe$Just(
				A2($author$project$Tablero$initPiece, piece.tetramino, model.rotations));
			var _v1 = model.hold;
			if (_v1.$ === 'Nothing') {
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{hold: toBeHolded, holdAvailable: false}),
					$author$project$Main$newPiece);
			} else {
				var holded = _v1.a;
				var translated = A3(
					$author$project$Tablero$rotate,
					model.rotations,
					piece.r,
					_Utils_update(
						holded,
						{grounded: piece.grounded, origin: piece.origin}));
				return A2($author$project$Tablero$testMovement, translated, model.tablero) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							active: $elm$core$Maybe$Just(translated),
							hold: toBeHolded,
							holdAvailable: false
						}),
...
var $author$project$Main$issueMsgAsCmd = function (msg) {
	return A2(
		$elm$core$Task$perform,
		$elm$core$Basics$identity,
		$elm$core$Task$succeed(msg));
};
var $author$project$Tablero$moveLeft = F2(
	function (p, tablero) {
		return A2(
			$elm$core$Maybe$map,
			function (piece) {
				var newPiece = _Utils_update(
					piece,
					{
						origin: {x: piece.origin.x, y: piece.origin.y - 1}
					});
				return A2($author$project$Tablero$testMovement, newPiece, tablero) ? newPiece : piece;
			},
			p);
	});
var $author$project$Tablero$moveRight = F2(
	function (p, tablero) {
		return A2(
			$elm$core$Maybe$map,
			function (piece) {
...
var $author$project$Tetramino$R1 = {$: 'R1'};
var $author$project$Tetramino$R2 = {$: 'R2'};
var $author$project$Tetramino$R3 = {$: 'R3'};
var $author$project$Tetramino$rotationDirection = F2(
	function (rPrev, rAct) {
		var _v0 = _Utils_Tuple2(rPrev, rAct);
		_v0$8:
		while (true) {
			switch (_v0.a.$) {
				case 'R1':
...
var $author$project$Tetramino$kickOffset = F4(
	function (t, rPrev, rAct, test) {
		var dir = A2($author$project$Tetramino$rotationDirection, rPrev, rAct);
		var block = function () {
			if (t.$ === 'I') {
				if (dir === 'clockwise') {
					switch (rPrev.$) {
...
var $author$project$Tablero$attemptKick = F3(
	function (rPrev, piece, tablero) {
		var reduceFunTests = F2(
			function (test, prev) {
				if (prev.$ === 'Just') {
					var p = prev.a;
					return $elm$core$Maybe$Just(p);
				} else {
					var kick = A4($author$project$Tetramino$kickOffset, piece.tetramino, rPrev, piece.r, test);
					var newPiece = _Utils_update(
						piece,
						{
							origin: {x: kick.x + piece.origin.x, y: kick.y + piece.origin.y}
						});
					return A2($author$project$Tablero$testMovement, newPiece, tablero) ? $elm$core$Maybe$Just(newPiece) : $elm$core$Maybe$Nothing;
				}
			});
		return A3(
			$elm$core$List$foldl,
...
var $author$project$Tablero$rotateLeft = F3(
	function (piece, tablero, rts) {
		return A2(
			$elm$core$Maybe$map,
			function (p) {
				var newPiece = function () {
					...
					switch (_v0.$) {
						case 'R1':
							return A3($author$project$Tablero$rotate, rts, $author$project$Tetramino$R4, p);
						case 'R2':
							return A3($author$project$Tablero$rotate, rts, $author$project$Tetramino$R1, p);
						case 'R3':
							return A3($author$project$Tablero$rotate, rts, $author$project$Tetramino$R2, p);
						default:
							return A3($author$project$Tablero$rotate, rts, $author$project$Tetramino$R3, p);
					}
				}();
				return A2($author$project$Tablero$testMovement, newPiece, tablero) ? newPiece : A2(
					$elm$core$Maybe$withDefault,
					p,
					A3($author$project$Tablero$attemptKick, p.r, newPiece, tablero));
			},
			piece);
	});
var $author$project$Tablero$rotateRight = F3(
	function (piece, tablero, rts) {
		return A2(
			$elm$core$Maybe$map,
			function (p) {
...
var $perty$matrix$Matrix$pickY = F2(
	function (y, arrays) {
		var _v0 = $elm$core$List$head(arrays);
		if (_v0.$ === 'Nothing') {
			return _List_Nil;
		} else {
			var array0 = _v0.a;
			var _v1 = A2($elm$core$Array$get, y, array0);
			if (_v1.$ === 'Nothing') {
				return _List_Nil;
			} else {
				var v = _v1.a;
				var _v2 = $elm$core$List$tail(arrays);
				if (_v2.$ === 'Nothing') {
					return _List_Nil;
				} else {
					var tail = _v2.a;
					return A2(
						$elm$core$List$cons,
						v,
						A2($perty$matrix$Matrix$pickY, y, tail));
				}
			}
		}
	});
var $perty$matrix$Matrix$getYs = F2(
	function (matrix, y) {
		return $elm$core$Array$fromList(
			A2(
				$perty$matrix$Matrix$pickY,
				y,
...
var $author$project$Tablero$shadowPosition = F2(
	function (piece, tablero) {
		if (A2($author$project$Tablero$testGrounded, piece, tablero).grounded > 0) {
			return $elm$core$Maybe$Nothing;
		} else {
			var sumarDeltas = function (d) {
				if (d.$ === 'Just') {
					var deltaV = d.a;
					return $elm$core$Maybe$Just(
						_Utils_update(
							piece,
							{
								origin: {x: piece.origin.x + deltaV, y: piece.origin.y}
							}));
				} else {
					return $elm$core$Maybe$Nothing;
				}
			};
			var distanceToGround = F2(
				function (block, _v3) {
					var distance = _v3.a;
					var found = _v3.b;
					return found ? _Utils_Tuple2(block, distance) : _Utils_Tuple2(
						block,
						$perty$matrix$Matrix$size(tablero).a);
				});
			var medirAltura = function (block) {
				return A2(
					distanceToGround,
					block,
					A3(
						...
						F2(
							function (tile, _v1) {
								...
								var found = _v1.b;
								if (tile.$ === 'Filled') {
									return _Utils_Tuple2(distance, true);
								} else {
									return found ? _Utils_Tuple2(distance, found) : _Utils_Tuple2(distance + 1, false);
								}
							}),
						_Utils_Tuple2(0, false),
						A2($perty$matrix$Matrix$getYs, tablero, block.y + piece.origin.y)));
			};
			var calcularDeltas = function (blocks) {
				return A2(
					$elm$core$List$map,
					function (_v0) {
						var block = _v0.a;
						var distance = _v0.b;
						return (distance - (block.x + piece.origin.x)) - 1;
					},
					blocks);
			};
			return sumarDeltas(
				$elm$core$List$minimum(
					calcularDeltas(
						A2($elm$core$List$map, medirAltura, piece.blocks))));
		}
	});
var $author$project$Tablero$sinkPiece = F2(
	function (piece, tablero) {
		if (piece.$ === 'Just') {
			var p = piece.a;
			var _v1 = A2($author$project$Tablero$shadowPosition, p, tablero);
			if (_v1.$ === 'Just') {
				var shadow = _v1.a;
				return $elm$core$Maybe$Just(
					_Utils_update(
						p,
						{grounded: 3, origin: shadow.origin}));
			} else {
				return $elm$core$Maybe$Just(p);
			}
		} else {
...
var $author$project$Main$update = F2(
	function (msg, modl) {
		var model = _Utils_update(
			modl,
			{actualMsg: msg, previousMsg: modl.previousMsg});
		switch (msg.$) {
			case 'Countdown':
				var n = msg.a;
				switch (n) {
					...
					case 'Playing':
						return _Utils_Tuple2(
							_Utils_update(
								...
								{
									active: model.next,
									next: $elm$core$Maybe$Just(
										A2($author$project$Tablero$initPiece, t, model.rotations)),
									state: $author$project$Main$Playing
								}),
							$elm$core$Platform$Cmd$none);
					case 'Starting':
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									...
									next: $elm$core$Maybe$Just(
										A2($author$project$Tablero$initPiece, t, model.rotations)),
									state: $author$project$Main$Starting(s)
								}),
							$elm$core$Platform$Cmd$none);
					default:
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			...
			case 'Advance':
				if (_Utils_eq(model.state, $author$project$Main$Playing)) {
					var _v3 = model.active;
					if (_v3.$ === 'Nothing') {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					} else {
						return $author$project$Main$groundPiece(
							_Utils_update(
								model,
								{
									active: A2($author$project$Tablero$advancePiece, model.active, model.tablero)
								}));
					}
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
						...
						case 'Right':
							return $author$project$Main$groundPiece(
								_Utils_update(
									model,
									{
										active: A2($author$project$Tablero$moveRight, model.active, model.tablero)
									}));
						case 'Left':
							return $author$project$Main$groundPiece(
								_Utils_update(
									model,
									{
										active: A2($author$project$Tablero$moveLeft, model.active, model.tablero)
									}));
						case 'Up':
							return $author$project$Main$groundPiece(
								_Utils_update(
									model,
									{
										active: A3($author$project$Tablero$rotateRight, model.active, model.tablero, model.rotations)
									}));
						case 'Down':
							return $author$project$Main$groundPiece(
								_Utils_update(
						...
						case 'Z':
							return $author$project$Main$groundPiece(
								_Utils_update(
									model,
									{
										active: A3($author$project$Tablero$rotateLeft, model.active, model.tablero, model.rotations)
									}));
						case 'Spacebar':
							return $author$project$Main$groundPiece(
								_Utils_update(
									model,
									{
										active: A2($author$project$Tablero$sinkPiece, model.active, model.tablero)
									}));
						case 'C':
							return $author$project$Main$holdPiece(model);
						case 'Escape':
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{pausedState: model.state, state: $author$project$Main$Paused}),
								$elm$core$Platform$Cmd$none);
						default:
							return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					}
				} else {
					var _v5 = event.keyCode;
					switch (_v5.$) {
						case 'Escape':
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										state: _Utils_eq(model.state, $author$project$Main$Paused) ? $author$project$Main$Playing : model.state
									}),
								$elm$core$Platform$Cmd$none);
						case 'Enter':
							return _Utils_Tuple2(
								model,
								$author$project$Main$issueMsgAsCmd(
			...
			case 'Pause':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							pausedState: model.state,
							state: paused ? $author$project$Main$Paused : model.pausedState
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
...
var $author$project$Main$viewContador = function (puntos) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('t-count-points')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$Debug$toString(puntos))
					]))
			]));
};
...
var $author$project$Main$viewControls = A2(
	...
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('t-controls')
		]),
	_List_fromArray(
		[
			A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$text(' Rotar derecha')
						])),
					A2(
					$elm$html$Html$li,
					_List_Nil,
					_List_fromArray(
						[
							...
							$elm$html$Html$text(' Rotar izquierda')
						])),
					A2(
					$elm$html$Html$li,
					_List_Nil,
					_List_fromArray(
						[
							...
							$elm$html$Html$text(' Fijar pieza')
						])),
					A2(
					$elm$html$Html$li,
					_List_Nil,
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$text(' Pause / Unpause')
						])),
					A2(
					$elm$html$Html$li,
					_List_Nil,
					_List_fromArray(
						[
							...
							$elm$html$Html$text(' Start / Restart if game is paused')
						]))
				])),
			A2(
			$elm$html$Html$h4,
			...
			A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Rows - Points')
									]))
							]))
					]),
				$elm$core$Dict$values(
					A2(
						...
						$author$project$Tablero$pointsTable))))
		]));
...
var $author$project$Main$viewPauseButton = function (state) {
	switch (state.$) {
		case 'Paused':
			return A2(
				...
				_List_fromArray(
					[
						...
						$author$project$Main$Pause(false)),
						$elm$html$Html$Attributes$class('t-resume')
					]),
				_List_fromArray(
					[
		...
		case 'Playing':
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick(
						$author$project$Main$Pause(true)),
						$elm$html$Html$Attributes$class('t-pause')
					]),
				_List_fromArray(
					[
...
var $author$project$Main$viewStartButton = function (state) {
	switch (state.$) {
		case 'NotStarted':
			return A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick(
						$author$project$Main$Countdown(3)),
						$elm$html$Html$Attributes$class('t-start')
					]),
				_List_fromArray(
					[
...
var $author$project$Tablero$Shadow = function (a) {
	return {$: 'Shadow', a: a};
};
var $author$project$Tablero$insertShadow = F2(
	function (piece, tablero) {
		return A3(
			$elm$core$List$foldl,
			F2(
				function (block, newTablero) {
					var y = block.y + piece.origin.y;
					var x = block.x + piece.origin.x;
					var _v0 = A3($perty$matrix$Matrix$get, tablero, x, y);
					if (_v0.$ === 'Nothing') {
						return newTablero;
					} else {
						if (_v0.a.$ === 'Empty') {
							...
							return A4(
								...
								x,
								y,
								$author$project$Tablero$Shadow(piece.tetramino));
						} else {
							return newTablero;
						}
					}
...
var $author$project$Tablero$viewCountdown = function (n) {
	if (!n) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('t-countdown')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(
...
var $author$project$Tablero$cssClass = function (t) {
	switch (t.$) {
		case 'I':
			return 't-i';
		case 'O':
...
var $author$project$Tablero$viewTile = F2(
	function (tile, rIndex) {
		switch (tile.$) {
			case 'Filled':
				var tetramino = tile.a;
				return A2(
					$elm$html$Html$li,
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									...
									_Utils_Tuple2(
									$author$project$Tablero$cssClass(tetramino),
									true)
								]))
						]),
					_List_Nil);
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									_Utils_Tuple2('t-tile-empty', true),
									_Utils_Tuple2('t-shadow', true)
								]))
						]),
					_List_Nil);
			default:
...
var $author$project$Tablero$viewRow = F2(
	function (row, index) {
		return A2(
			$elm$html$Html$ul,
			_List_fromArray(
			...
			$elm$core$Array$toList(
				A2(
					$elm$core$Array$map,
					function (r) {
						return A2($author$project$Tablero$viewTile, r, index);
					},
					row)));
	});
var $author$project$Tablero$viewTablero = F4(
	function (tablero, piece, countdown, _class) {
		var tableroWithActive = function () {
			if (piece.$ === 'Just') {
				var p = piece.a;
				if (_class === 't-tablero') {
					return A2($author$project$Tablero$insertPiece, p, tablero);
				} else {
					return A2(
						$author$project$Tablero$insertPiece,
						_Utils_update(
							p,
							{
								blocks: function () {
		...
		var tableroWithShadow = function () {
			if (!('t-tablero' === _class)) {
				return tableroWithActive;
			} else {
				if (piece.$ === 'Just') {
					var p = piece.a;
					var shadow = A2($author$project$Tablero$shadowPosition, p, tablero);
					if (shadow.$ === 'Nothing') {
						return tableroWithActive;
					} else {
						var s = shadow.a;
						return A2($author$project$Tablero$insertShadow, s, tableroWithActive);
					}
				} else {
					return tableroWithActive;
				}
			...
			$elm$core$List$concat(
				_List_fromArray(
					[
						...
						function (row) {
							return A2(
								$author$project$Tablero$viewRow,
								A2($perty$matrix$Matrix$getXs, tableroWithShadow, row),
								row);
						},
...
var $author$project$Main$view = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('tetris')
			]),
		_List_fromArray(
			[
				$author$project$Main$viewStartButton(model.state),
				$author$project$Main$viewPauseButton(model.state),
				$author$project$Main$viewContador(model.points),
				$author$project$Main$viewControls,
				A4($author$project$Tablero$viewTablero, model.tablero, model.active, countdown, 't-tablero'),
				A4(
				$author$project$Tablero$viewTablero,
				A2($author$project$Tablero$initTablero, 4, 6),
				model.hold,
				0,
				't-hold'),
				A4(
