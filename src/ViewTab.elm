...
embeddedTab4 =
        [ 
          instragramEmbeddedWrapper instagramReelsEmbedSpringGirl
        , instragramEmbeddedWrapper instagramReelsEmbedCarnivalRow
        , instragramEmbeddedWrapper instagramReelsEmbedCouple
        ]
...
instragramEmbeddedWrapper : String -> String 
instragramEmbeddedWrapper content = 
    """
        <!DOCTYPE html>
        <html lang="en">
        <head>
...
instagramReelsEmbedSpringGirl =    
    ...
    <blockquote class="instagram-media" data-instgrm-captioned
        ...
        style=" background:#FFF; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:150px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">
...
instagramReelsEmbedCouple  : String
instagramReelsEmbedCouple = 
    """
    <blockquote class="instagram-media" data-instgrm-captioned
