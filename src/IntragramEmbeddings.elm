module IntragramEmbeddings exposing (..)


import Element exposing (Device)
import Base exposing (LayoutConf, layoutConf)

instragramEmbeddedWrapper : Device -> (String -> String) -> String 
instragramEmbeddedWrapper device content = 
    let 
        ...
        attrs = """
                ...
                margin: 1px; 
                max-width:""" ++ String.fromInt conf.instragramEmbeddingMaxWidth ++ """px; 
                min-width:""" ++ String.fromInt conf.instragramEmbeddingMinWidth ++ """px; 
                padding:0; 
                width:99.375%; 
...
instagramReelsEmbedSpringGirl : String -> String
instagramReelsEmbedSpringGirl attrs =    
    """
...
instagramReelsEmbedCarnivalRow :  String -> String
instagramReelsEmbedCarnivalRow attrs = 
    """
    <blockquote class="instagram-media" data-instgrm-captioned
...
instagramReelsEmbedCouple  :  String -> String
instagramReelsEmbedCouple attrs = 
    """
    <blockquote class="instagram-media" data-instgrm-captioned
